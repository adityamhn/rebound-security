...
import { getAllActions, getAllCredentials, getAllFingerprints, getAllRequests, getAllSessions } from '@/services/logs.service'
import FingerprintsTable from '@/components/common/tables/FingerprintsTable'
import RequestsTable from '@/components/common/tables/RequestsTable'
...
const HTTPRequests = () => {
  ...
  const { data, isLoading } = useQuery("http", getAllRequests, {
      ...
      <div className={styles.dashboardContainer}>
        <div className={styles.dashboardHeader}>
          ...
          <p className={styles.description}>
            This page shows HTTP requests detected by the honeypots
          </p>
        </div>
        ...
        <div className={styles.dashboardTableContainer}>
          <RequestsTable sessions={data?.requests} loading={isLoading && !data}/>
        </div>
